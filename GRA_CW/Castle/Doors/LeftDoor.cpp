...
//Drawing the left door. glDrawElements, glTexCoordPointer and gl vertexPointer is used to draw the building and texture it using a predefined points in the header file
void LeftDoor::drawDoor(){
    glPushMatrix();
